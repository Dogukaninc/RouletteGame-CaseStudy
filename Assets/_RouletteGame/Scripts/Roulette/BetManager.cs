...
namespace RouletteGame.Scripts
{
    public class BetManager : MonoBehaviour
    {
        ...
        private void SelectChipToSpawn(int chipValue)
        {
            ...
            _audioManager.PlaySound(Tags.SOUND_TAG_SELECT);
        }
        ...
        private void PlaceChipOnBet(BetTile betTile)
        {
            ...
            var calculatedBetAmount = GetChipValueFromTag(_selectedChipTag);
            AddBet(calculatedBetAmount);
            betTile.CalculateBetAmountOnTile(calculatedBetAmount);
            
            _audioManager.PlaySound(Tags.SOUND_TAG_CHIP);
        }
        ...
        public List<BetTile> GetAllBets()
        {
